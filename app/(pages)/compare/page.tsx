...
import { addToCart, toggleCompare } from "@/redux/services/shop/globalSlice";
import {
  Table,
  TableBody,
  TableCell,
...
export default function ShopPage() {
  ...
  const handleRemoveFromCompare = (product: Product) => {
    ...
    toast.success("Removed from your compare");
  };

  return (
    <div className="container mx-auto py-8 px-4 md:px-8">
      <h1 className="text-3xl font-medium mb-8 text-center">Compare</h1>
